(function(factory) {
  ...
  function close(actual, expected, maxDifference, message) {
	if (typeof actual === "object")
		closeObj(actual,expected,maxDifference, message);
	else{
  ...
  function closeObj(actual,expected,maxDifference, message){
	for (var key in expected) 
	    if (expected.hasOwnProperty(key)) 
			close(actual[key], expected[key], maxDifference, message);
